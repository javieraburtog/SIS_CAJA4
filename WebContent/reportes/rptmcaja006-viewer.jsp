...
com.casapellas.entidades.Vrptmcaja006Id,
...
java.util.List"%><%
	...
	try {
		...
		String reportName = "reportes/rptmcaja006.rpt";
		...
		if (clientDoc == null) {
			...
			{	//----  Relleno del Encabezado de reporte.
				 ...
				 lstRptmcajaHeader = ses.getValue("rptmcaja006_hd")==null?new ArrayList(1):(ArrayList)ses.getValue("rptmcaja006_hd");
			...
			{	//----  Relleno del cuerpo del reporte.
				 String className = "com.casapellas.entidades.Vrptmcaja006Id";
				 String tableAlias = "Vrptmcaja006Id";
				 HttpSession ses = session;	
				 List lstDatosRpt = null;
				 lstDatosRpt = ses.getValue("rptmcaja006_bd")==null? new ArrayList(1):(ArrayList)ses.getValue("rptmcaja006_bd");
				 //JRCHelperSample.passPOJO(clientDoc, lstDatosRpt, className, tableAlias, "");
				 clientDoc.getDatabaseController().setDataSource(lstDatosRpt, Vrptmcaja006Id.class, "Vrptmcaja006Id", "Vrptmcaja006Id");
			}
		...
		{	//------- propiedades del reporte, del Visor y proceso del rpt.
			...
			crystalReportPageViewer.setName("ReporteRecibosDeCaja");
