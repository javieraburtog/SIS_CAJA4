...
public class ArqueoControl {
	...
	/*public List obtenerRecpagBanco(int iCaid, String sCodsuc,String sCodcomp, String sMoneda,
			...
			try{
				...
				try { HibernateUtilPruebaCn.closeSession(); HibernateUtil.closeSession();  sesion.close(); } catch (Exception e) { }
			}
			return lstRecibos;
		}*/
	 ...
	 **/
		/*public List obtenerDevolucionDeldia(String[] sTiposDoc ,F55ca017[] f55ca017,List lstLocalizaciones,
			...
			try {
				...
				sExclTf += " and tf.fechafac = f.fechadev ";
				...
				sqlTf += " and tf.fechafac = f.fechadev "; 
				sqlTf += " and trim(f.estado) = ''  and f.codcomp = '" +sCodcomp+ "' and f.moneda = '" +sMoneda+ "'";
				sqlTf += sRangoFecha;
				...
				System.out.println("Error en ArqueoCAjaCtrl.obtenerDevolucionDeldia " + error);
			} finally{
				try {HibernateUtilPruebaCn.closeSession(); HibernateUtil.closeSession();  sesion.close(); } catch (Exception e) {}
			}
			return lstDev;
