...
public class ReciboCtrlV2 {
	public Exception errorDetalle;
	public Exception error;
	
	
	static String[] valoresJdeNumeracion ;
	static String[] valoresJDEInsContado ;
	...
	public ReciboCtrlV2() {
		...
		valoresJdeNumeracion = (String[]) m.get("valoresJDENumeracionIns");
		valoresJDEInsContado = (String[]) m.get("valoresJDEInsContado");}
		else {
			...
			List<Object> valoresContado= sesion.createSQLQuery(query).list();
			valoresJDEInsContado = valoresContado.get(0).toString().split(",",-1);
			
			String queryNumeracion="SELECT TVALALF FROM "+PropertiesSystem.ESQUEMA+".CAJAPARM WHERE TPARM = '"+ PropertiesSystem.parametroCaja + "' AND TCOD = '"+ PropertiesSystem.valuesJDENumeracion +"' ";
			List<Object> valoresNumeracion= sesion.createSQLQuery(queryNumeracion).list();
			
			valoresJdeNumeracion= valoresNumeracion.get(0).toString().split(",",-1);
		}
